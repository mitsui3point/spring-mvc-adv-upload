...
public class ItemServiceTest {
    ...
    private void itemResultAssert(MultipartFile testAttachFile, List<MultipartFile> testImageFiles, ItemResult actual, String expectedItemName) throws IOException {
        ...
        assertThat(actual).extracting("name").isEqualTo(expectedItemName);
        ...
        //item attach file
        byte[] actualAttachFileBytes = new FileInputStream(uploadDir + storeAttachFileName).readAllBytes();
        ...
        for (UploadFile imageFile : actual.getImageFiles()) {
            ...
            actualImageFileBytes = new FileInputStream(uploadDir + storeImageFileName).readAllBytes();
